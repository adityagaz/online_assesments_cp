...
public class intuit_oa implements Runnable {
    ...
    static void solve(FastReader sc ) throws Exception {
        ...
        while(t-- > 0) {
        	...
        	if(str[0].equals("S") && str[1].equals("*")) res.append("J");
        	else if(str[0].equals("S") && str[1].equals("_"))res.append("W");

        	for( int i = 1 ; i<=n-3 ; i++ ) {
        		String curr = str[i];
        		String next = str[i+1];
        		if(curr.equals("_") && next.equals("*")) res.append("J");
        		else if(curr.equals("_") && next.equals("_")) res.append("W");
        		else if (curr.equals("*") && next.equals("_") ) continue;
        		else if(curr.equals("*") && next.equals("*")) continue;
         	}

         	if(str[n-2].equals("_") && str[n-1].equals("D")) res.append("W");
