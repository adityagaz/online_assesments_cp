...
public class equality_equations implements Runnable {
    final static long mod = 1_000_000_007L;
    static PrintWriter out;


    public static void main(String[] args) {
        new Thread(null, new equality_equations (), "whatever", 1 << 30).start();
    }
    ...
    static int [] comp;
    static int [] vis;
    public static boolean equationsPossible(String[] e) {
    ...
    static void dfs(int node , int comp_num) {
        comp[node]= comp_num;
