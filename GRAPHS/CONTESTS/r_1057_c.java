...
public class r_1057_c implements Runnable {
    final static long mod = 1_000_000_007L;
    static PrintWriter out;


    public static void main(String[] args) {
        new Thread(null, new r_1057_c (), "whatever", 1 << 30).start();
    }
    ...
    static void mergeSort(int [] arr , int n) {
        ...
        merge(arr , l , r , mid , n-mid , n);



    }

    static void merge(int [] arr , int [] l  , int [] r , int left , int right , int n ) {
        int i = 0, j = 0 , k = 0;
