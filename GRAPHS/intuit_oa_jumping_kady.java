...
public class intuit_oa_jumping_kady implements Runnable {
    final static long mod = 1_000_000_007L;
    static PrintWriter out;


    public static void main(String[] args) {
        new Thread(null, new intuit_oa_jumping_kady (), "whatever", 1 << 30).start();
    }
    ...
    static int [][] dist;
    static int [][] vis;
    static void solve(FastReader s ) throws Exception {
