...
public class trigo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        double pi = Math.acos((double)-1.0); //value of pi
        System.out.printf("%.11f%n" , pi*r*r); //round of to 11 decimal places
    ...
    private static void print(Double v)               { out.print(v); }
    private static void printl(Double v)              { out.println(v); }
